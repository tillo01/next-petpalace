...
const MyMenu = () => {
	...
	if (device === 'mobile') {
		...
		return (
			<Stack width={'100%'} padding={'30px 24px'} flexDirection="row" justifyContent="space-around">
					...
					<Stack className={'section'} style={{ height: user.memberType === 'SELLER' ? '228px' : '153px' }}>
						...
						<List className={'sub-section'}>
							{user.memberType === 'SELLER' && (
								<>
									<ListItem className={pathname === 'addPet' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'addPet' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
												...
												<IconButton aria-label="delete" sx={{ ml: '40px' }}>
													{/* <PortraitIcon style={{ color: '#7ed957' }} /> */}
												</IconButton>
											</div>
										</Link>
									</ListItem>
									<ListItem className={pathname === 'myPets' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'myPets' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
