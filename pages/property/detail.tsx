								...
								<Stack className={'left-box'}>
									...
									<Stack className={'bottom-box'}>
										<Stack className="option">
											<img src="/img/icons/weight.png" alt="" /> <Typography>{property?.propertyBeds} bed</Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/height.png" alt="" /> <Typography>{property?.propertyRooms} room</Typography>
										</Stack>
